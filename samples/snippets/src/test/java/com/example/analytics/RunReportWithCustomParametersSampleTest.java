...
/** Tests for the RunReportWithCustomParameters sample. */
@RunWith(JUnit4.class)
public class RunReportWithCustomParametersSampleTest {
  ...
  private String runSample(String ga4PropertyId) throws Exception {
    ...
    RunReportWithCustomParametersSample.sampleRunReportWithCustomParameters(ga4PropertyId);
    System.setOut(stdOut);
    return bout.toString();
  }

  @Test
  public void testRunReportWithCustomParameters() throws Exception {
    // Act
