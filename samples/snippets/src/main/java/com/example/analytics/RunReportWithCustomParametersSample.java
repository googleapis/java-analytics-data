...
public class RunReportWithCustomParametersSample {
  ...
  public static void main(String... args) throws Exception {
    ...
    sampleRunReportWithCustomParameters(propertyId);
  }

  // Runs a report of active users grouped by country.
  static void sampleRunReportWithCustomParameters(String propertyId) throws Exception {
