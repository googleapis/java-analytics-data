...
public interface RunReportRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.analytics.data.v1alpha.Dimension> 
      getDimensionsList();
  /**
   * <pre>
   * The dimensions requested and displayed.
   ...
   * <code>repeated .google.analytics.data.v1alpha.Dimension dimensions = 2;</code>
   */
  com.google.analytics.data.v1alpha.DimensionOrBuilder getDimensionsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.analytics.data.v1alpha.Metric> 
      getMetricsList();
  /**
   * <pre>
   * The metrics requested and displayed.
   ...
   */
  java.util.List<com.google.analytics.data.v1alpha.OrderBy> 
      getOrderBysList();
  /**
   * <pre>
   * Specifies how rows are ordered in the response.
   ...
   * <code>repeated .google.analytics.data.v1alpha.OrderBy order_bys = 10;</code>
   */
  com.google.analytics.data.v1alpha.OrderByOrBuilder getOrderBysOrBuilder(
      int index);
