...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26: {
            ...
            dateRange_ = input.readMessage(com.google.analytics.data.v1alpha.DateRange.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.analytics.data.v1alpha.ReportingApiProto.internal_static_google_analytics_data_v1alpha_Cohort_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.google.analytics.data.v1alpha.ReportingApiProto.internal_static_google_analytics_data_v1alpha_Cohort_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.analytics.data.v1alpha.Cohort.class, com.google.analytics.data.v1alpha.Cohort.Builder.class);
  }
  ...
  public com.google.analytics.data.v1alpha.DateRange getDateRange() {
    return dateRange_ == null ? com.google.analytics.data.v1alpha.DateRange.getDefaultInstance() : dateRange_;
  }
  /**
   * <pre>
   * The cohort selects users whose first touch date is between start date and
  ...
  public static com.google.analytics.data.v1alpha.Cohort parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    public com.google.analytics.data.v1alpha.Cohort buildPartial() {
      com.google.analytics.data.v1alpha.Cohort result = new com.google.analytics.data.v1alpha.Cohort(this);
      result.name_ = name_;
  ...
  checkByteStringIsUtf8(value);
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.DateRange, com.google.analytics.data.v1alpha.DateRange.Builder, com.google.analytics.data.v1alpha.DateRangeOrBuilder> dateRangeBuilder_;
    /**
     * <pre>
     * The cohort selects users whose first touch date is between start date and
     * end date defined in the `dateRange`. This `dateRange` does not specify the
    ...
    public Builder mergeDateRange(com.google.analytics.data.v1alpha.DateRange value) {
      if (dateRangeBuilder_ == null) {
        if (dateRange_ != null) {
          dateRange_ =
            com.google.analytics.data.v1alpha.DateRange.newBuilder(dateRange_).mergeFrom(value).buildPartial();
        } else {
          dateRange_ = value;
        }
        onChanged();
    ...
    public com.google.analytics.data.v1alpha.DateRangeOrBuilder getDateRangeOrBuilder() {
      if (dateRangeBuilder_ != null) {
        ...
        return dateRange_ == null ?
            com.google.analytics.data.v1alpha.DateRange.getDefaultInstance() : dateRange_;
      }
    }
    /**
     * <pre>
