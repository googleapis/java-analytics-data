...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            cohorts_.add(
                input.readMessage(com.google.analytics.data.v1alpha.Cohort.parser(), extensionRegistry));
            break;
          }
          case 18: {
            ...
            cohortsRange_ = input.readMessage(com.google.analytics.data.v1alpha.CohortsRange.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 26: {
            ...
            cohortReportSettings_ = input.readMessage(com.google.analytics.data.v1alpha.CohortReportSettings.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.analytics.data.v1alpha.ReportingApiProto.internal_static_google_analytics_data_v1alpha_CohortSpec_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.google.analytics.data.v1alpha.ReportingApiProto.internal_static_google_analytics_data_v1alpha_CohortSpec_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.analytics.data.v1alpha.CohortSpec.class, com.google.analytics.data.v1alpha.CohortSpec.Builder.class);
  }
   ...
   */
  @java.lang.Override
  public com.google.analytics.data.v1alpha.CohortOrBuilder getCohortsOrBuilder(
      int index) {
    return cohorts_.get(index);
  }
  ...
  public com.google.analytics.data.v1alpha.CohortsRange getCohortsRange() {
    return cohortsRange_ == null ? com.google.analytics.data.v1alpha.CohortsRange.getDefaultInstance() : cohortsRange_;
  }
  /**
   * <pre>
   * Cohort reports follow cohorts over an extended reporting date range. This
  ...
  public com.google.analytics.data.v1alpha.CohortReportSettings getCohortReportSettings() {
    return cohortReportSettings_ == null ? com.google.analytics.data.v1alpha.CohortReportSettings.getDefaultInstance() : cohortReportSettings_;
  }
  /**
   * <pre>
   * Optional settings for a cohort report.
   ...
   */
  @java.lang.Override
  public com.google.analytics.data.v1alpha.CohortReportSettingsOrBuilder getCohortReportSettingsOrBuilder() {
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < cohorts_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, cohorts_.get(i));
    }
    if (cohortsRange_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(2, getCohortsRange());
    }
    if (cohortReportSettings_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(3, getCohortReportSettings());
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.analytics.data.v1alpha.CohortSpec other = (com.google.analytics.data.v1alpha.CohortSpec) obj;

    if (!getCohortsList()
        .equals(other.getCohortsList())) return false;
    if (hasCohortsRange() != other.hasCohortsRange()) return false;
    if (hasCohortsRange()) {
      if (!getCohortsRange()
          .equals(other.getCohortsRange())) return false;
    }
    if (hasCohortReportSettings() != other.hasCohortReportSettings()) return false;
    if (hasCohortReportSettings()) {
      if (!getCohortReportSettings()
          .equals(other.getCohortReportSettings())) return false;
    }
  ...
  public static com.google.analytics.data.v1alpha.CohortSpec parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    public com.google.analytics.data.v1alpha.CohortSpec buildPartial() {
      com.google.analytics.data.v1alpha.CohortSpec result = new com.google.analytics.data.v1alpha.CohortSpec(this);
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.analytics.data.v1alpha.Cohort, com.google.analytics.data.v1alpha.Cohort.Builder, com.google.analytics.data.v1alpha.CohortOrBuilder> cohortsBuilder_;
    ...
    public Builder setCohorts(
        int index, com.google.analytics.data.v1alpha.Cohort value) {
      if (cohortsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder addCohorts(
        com.google.analytics.data.v1alpha.Cohort.Builder builderForValue) {
      if (cohortsBuilder_ == null) {
        ensureCohortsIsMutable();
     ...
     * <code>repeated .google.analytics.data.v1alpha.Cohort cohorts = 1;</code>
     */
    public com.google.analytics.data.v1alpha.Cohort.Builder getCohortsBuilder(
        int index) {
    ...
    public com.google.analytics.data.v1alpha.Cohort.Builder addCohortsBuilder() {
      return getCohortsFieldBuilder().addBuilder(
          com.google.analytics.data.v1alpha.Cohort.getDefaultInstance());
    }
    /**
     * <pre>
     * Defines the selection criteria to group users into cohorts.
    ...
    public com.google.analytics.data.v1alpha.Cohort.Builder addCohortsBuilder(
        int index) {
      return getCohortsFieldBuilder().addBuilder(
          index, com.google.analytics.data.v1alpha.Cohort.getDefaultInstance());
    }
    /**
     * <pre>
     * Defines the selection criteria to group users into cohorts.
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.analytics.data.v1alpha.Cohort, com.google.analytics.data.v1alpha.Cohort.Builder, com.google.analytics.data.v1alpha.CohortOrBuilder> 
        getCohortsFieldBuilder() {
      if (cohortsBuilder_ == null) {
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.CohortsRange, com.google.analytics.data.v1alpha.CohortsRange.Builder, com.google.analytics.data.v1alpha.CohortsRangeOrBuilder> cohortsRangeBuilder_;
    /**
     * <pre>
     * Cohort reports follow cohorts over an extended reporting date range. This
     * range specifies an offset duration to follow the cohorts over.
    ...
    public Builder mergeCohortsRange(com.google.analytics.data.v1alpha.CohortsRange value) {
      if (cohortsRangeBuilder_ == null) {
        if (cohortsRange_ != null) {
          cohortsRange_ =
            com.google.analytics.data.v1alpha.CohortsRange.newBuilder(cohortsRange_).mergeFrom(value).buildPartial();
        } else {
          cohortsRange_ = value;
        }
        onChanged();
    ...
    public com.google.analytics.data.v1alpha.CohortsRangeOrBuilder getCohortsRangeOrBuilder() {
      if (cohortsRangeBuilder_ != null) {
        ...
        return cohortsRange_ == null ?
            com.google.analytics.data.v1alpha.CohortsRange.getDefaultInstance() : cohortsRange_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.CohortsRange, com.google.analytics.data.v1alpha.CohortsRange.Builder, com.google.analytics.data.v1alpha.CohortsRangeOrBuilder> 
    ...
    private com.google.analytics.data.v1alpha.CohortReportSettings cohortReportSettings_;
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.CohortReportSettings, com.google.analytics.data.v1alpha.CohortReportSettings.Builder, com.google.analytics.data.v1alpha.CohortReportSettingsOrBuilder> cohortReportSettingsBuilder_;
    /**
     * <pre>
     * Optional settings for a cohort report.
     * </pre>
     ...
     * <code>.google.analytics.data.v1alpha.CohortReportSettings cohort_report_settings = 3;</code>
     */
    public Builder setCohortReportSettings(com.google.analytics.data.v1alpha.CohortReportSettings value) {
      if (cohortReportSettingsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.google.analytics.data.v1alpha.CohortReportSettings cohort_report_settings = 3;</code>
     */
    public Builder mergeCohortReportSettings(com.google.analytics.data.v1alpha.CohortReportSettings value) {
      if (cohortReportSettingsBuilder_ == null) {
        if (cohortReportSettings_ != null) {
          cohortReportSettings_ =
            com.google.analytics.data.v1alpha.CohortReportSettings.newBuilder(cohortReportSettings_).mergeFrom(value).buildPartial();
        } else {
          cohortReportSettings_ = value;
        }
        onChanged();
     ...
     * <code>.google.analytics.data.v1alpha.CohortReportSettings cohort_report_settings = 3;</code>
     */
    public com.google.analytics.data.v1alpha.CohortReportSettings.Builder getCohortReportSettingsBuilder() {
    ...
    public com.google.analytics.data.v1alpha.CohortReportSettingsOrBuilder getCohortReportSettingsOrBuilder() {
      if (cohortReportSettingsBuilder_ != null) {
        ...
        return cohortReportSettings_ == null ?
            com.google.analytics.data.v1alpha.CohortReportSettings.getDefaultInstance() : cohortReportSettings_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.CohortReportSettings, com.google.analytics.data.v1alpha.CohortReportSettings.Builder, com.google.analytics.data.v1alpha.CohortReportSettingsOrBuilder> 
        getCohortReportSettingsFieldBuilder() {
      if (cohortReportSettingsBuilder_ == null) {
        cohortReportSettingsBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.analytics.data.v1alpha.CohortReportSettings, com.google.analytics.data.v1alpha.CohortReportSettings.Builder, com.google.analytics.data.v1alpha.CohortReportSettingsOrBuilder>(
  ...
  private static final com.google.protobuf.Parser<CohortSpec>
      PARSER = new com.google.protobuf.AbstractParser<CohortSpec>() {
    @java.lang.Override
