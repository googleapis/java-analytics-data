...
public interface RunReportResponseOrBuilder extends
   ...
   * <code>repeated .google.analytics.data.v1alpha.Row totals = 8;</code>
   */
  com.google.analytics.data.v1alpha.RowOrBuilder getTotalsOrBuilder(
      int index);
   ...
   * <code>repeated .google.analytics.data.v1alpha.Row maximums = 9;</code>
   */
  com.google.analytics.data.v1alpha.RowOrBuilder getMaximumsOrBuilder(
      int index);
   ...
   * <code>repeated .google.analytics.data.v1alpha.Row minimums = 10;</code>
   */
  com.google.analytics.data.v1alpha.RowOrBuilder getMinimumsOrBuilder(
      int index);
